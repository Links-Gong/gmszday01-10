...
SET @source_row_count = (SELECT COUNT(*) FROM ec_cross_border.amazonus_shopinfo_202601_sales);
SET @empty_shop_id_count = (
    SELECT COUNT(*) FROM ec_cross_border.amazonus_shopinfo_202601_sales
...
SET @valid_shop_count = (
    ...
    FROM ec_cross_border.amazonus_shopinfo_202601_sales
...
INSERT INTO etl_load_audit_2026_gj (
    ...
    '202601-2', 202601, 2, 'Amazon', 'amazonus_shopinfo_202601_sales',
    @source_row_count, @empty_shop_id_count, @valid_shop_count,
...
WHERE month_id = 202601 AND platform_id = 2;
...
WITH cleaned AS (
    ...
    FROM ec_cross_border.amazonus_shopinfo_202601_sales s
...
SELECT
    202601, 2, 'Amazon', a.shop_id, a.shop_name,
...
CALL sp_promote_dwd_batch_2026_gj(202601, 2);
