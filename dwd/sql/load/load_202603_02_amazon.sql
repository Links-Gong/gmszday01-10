...
SET @source_row_count = (SELECT COUNT(*) FROM ec_cross_border.amazonus_shopinfo_202603_sales);
SET @empty_shop_id_count = (
    SELECT COUNT(*) FROM ec_cross_border.amazonus_shopinfo_202603_sales
...
SET @valid_shop_count = (
    ...
    FROM ec_cross_border.amazonus_shopinfo_202603_sales
...
INSERT INTO etl_load_audit_2026_gj (
    ...
    '202603-2', 202603, 2, 'Amazon', 'amazonus_shopinfo_202603_sales',
    @source_row_count, @empty_shop_id_count, @valid_shop_count,
...
WHERE month_id = 202603 AND platform_id = 2;
...
WITH cleaned AS (
    ...
    FROM ec_cross_border.amazonus_shopinfo_202603_sales s
...
SELECT
    202603, 2, 'Amazon', a.shop_id, a.shop_name,
...
CALL sp_promote_dwd_batch_2026_gj(202603, 2);
