...
SET @source_row_count = (SELECT COUNT(*) FROM ec_cross_border.alibabagj_shopinfo_202604);
SET @empty_shop_id_count = (
    SELECT COUNT(*) FROM ec_cross_border.alibabagj_shopinfo_202604
...
SET @valid_shop_count = (
    ...
    FROM ec_cross_border.alibabagj_shopinfo_202604
...
INSERT INTO etl_load_audit_2026_gj (
    ...
    '202604-3', 202604, 3, 'Alibaba', 'alibabagj_shopinfo_202604',
    @source_row_count, @empty_shop_id_count, @valid_shop_count,
...
WHERE month_id = 202604 AND platform_id = 3;
...
WITH cleaned AS (
    ...
    FROM ec_cross_border.alibabagj_shopinfo_202604 s
...
SELECT
    202604, 3, 'Alibaba', a.shop_id, a.shop_name,
...
CALL sp_promote_dwd_batch_2026_gj(202604, 3);
