...
SET @source_row_count = (SELECT COUNT(*) FROM ec_cross_border.smt_shopinfo_202606);
SET @empty_shop_id_count = (
    SELECT COUNT(*) FROM ec_cross_border.smt_shopinfo_202606
...
INSERT INTO etl_load_audit_2026_gj (
    ...
    '202606-1', 202606, 1, 'SMT', 'smt_shopinfo_202606',
    @source_row_count, @empty_shop_id_count, @valid_shop_count,
...
WHERE month_id = 202606 AND platform_id = 1;
...
WITH cleaned AS (
    ...
    FROM ec_cross_border.smt_shopinfo_202606 s
...
SELECT
    202606, 1, 'SMT', shop_id, shop_name,
    company_name, company_address, country, province, city, county,
    sales_num_value,
...
CALL sp_promote_dwd_batch_2026_gj(202606, 1);
