...
SET @source_row_count = (SELECT COUNT(*) FROM ec_cross_border.smt_shopinfo_202601);
SET @empty_shop_id_count = (
    SELECT COUNT(*) FROM ec_cross_border.smt_shopinfo_202601
...
SET @valid_shop_count = (
    ...
    FROM ec_cross_border.smt_shopinfo_202601
...
INSERT INTO etl_load_audit_2026_gj (
    ...
    '202601-1', 202601, 1, 'SMT', 'smt_shopinfo_202601',
    @source_row_count, @empty_shop_id_count, @valid_shop_count,
...
WITH cleaned AS (
    ...
    FROM ec_cross_border.smt_shopinfo_202601 s
...
SELECT
    202601, 1, 'SMT', shop_id, shop_name,
    company_name, company_address, country, province, city, county,
    sales_num_value,
...
CALL sp_promote_dwd_batch_2026_gj(202601, 1);
