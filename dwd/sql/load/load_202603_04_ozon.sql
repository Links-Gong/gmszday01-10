...
SET @source_row_count = (SELECT COUNT(*) FROM ec_cross_border.ozon_shopinfo_202603_cn);
SET @empty_shop_id_count = (
    SELECT COUNT(*) FROM ec_cross_border.ozon_shopinfo_202603_cn
...
INSERT INTO etl_load_audit_2026_gj (
    ...
    '202603-4', 202603, 4, 'Ozon', 'ozon_shopinfo_202603_cn',
    @source_row_count, @empty_shop_id_count, @valid_shop_count,
...
WHERE month_id = 202603 AND platform_id = 4;
...
WITH cleaned AS (
    ...
    FROM ec_cross_border.ozon_shopinfo_202603_cn o
...
SELECT
    202603, 4, 'Ozon', a.shop_id, a.shop_name,
...
CALL sp_promote_dwd_batch_2026_gj(202603, 4);
