...
SET @source_row_count = (SELECT COUNT(*) FROM ec_cross_border.smt_shopinfo_202602);
SET @empty_shop_id_count = (
    SELECT COUNT(*) FROM ec_cross_border.smt_shopinfo_202602
...
SET @valid_shop_count = (
    ...
    FROM ec_cross_border.smt_shopinfo_202602
...
INSERT INTO etl_load_audit_2026_gj (
    ...
    '202602-1', 202602, 1, 'SMT', 'smt_shopinfo_202602',
    @source_row_count, @empty_shop_id_count, @valid_shop_count,
...
WHERE month_id = 202602 AND platform_id = 1;
...
WITH cleaned AS (
    ...
    FROM ec_cross_border.smt_shopinfo_202602 s
...
SELECT
    202602, 1, 'SMT', shop_id, shop_name,
    company_name, company_address, country, province, city, county,
    sales_num_value,
...
CALL sp_promote_dwd_batch_2026_gj(202602, 1);
