...
SET @source_row_count = (SELECT COUNT(*) FROM ec_cross_border.alibabagj_shopinfo_202603);
SET @empty_shop_id_count = (
    SELECT COUNT(*) FROM ec_cross_border.alibabagj_shopinfo_202603
...
SET @valid_shop_count = (
    ...
    FROM ec_cross_border.alibabagj_shopinfo_202603
...
INSERT INTO etl_load_audit_2026_gj (
    ...
    '202603-3', 202603, 3, 'Alibaba', 'alibabagj_shopinfo_202603',
    @source_row_count, @empty_shop_id_count, @valid_shop_count,
...
WHERE month_id = 202603 AND platform_id = 3;
...
WITH cleaned AS (
    ...
    FROM ec_cross_border.alibabagj_shopinfo_202603 s
...
SELECT
    202603, 3, 'Alibaba', a.shop_id, a.shop_name,
...
CALL sp_promote_dwd_batch_2026_gj(202603, 3);
