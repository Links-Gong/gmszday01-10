...
SET @source_row_count = (SELECT COUNT(*) FROM ec_cross_border.ozon_shopinfo_202506_cn);
SET @empty_shop_id_count = (
    SELECT COUNT(*) FROM ec_cross_border.ozon_shopinfo_202506_cn
...
SET @valid_shop_count = (
    ...
    FROM ec_cross_border.ozon_shopinfo_202506_cn
...
INSERT INTO etl_load_audit_2025_gj (
    ...
    '202506-4', 202506, 4, 'Ozon', 'ozon_shopinfo_202506_cn',
    @source_row_count, @empty_shop_id_count, @valid_shop_count,
...
WHERE month_id = 202506 AND platform_id = 4;
...
SELECT
    202506, 4, 'Ozon', a.shop_id, a.shop_name,
...
CALL sp_promote_dwd_batch_2025_gj(202506, 4);
