...
SET @source_row_count = (SELECT COUNT(*) FROM ec_cross_border.amazonus_shopinfo_202504_sales);
SET @empty_shop_id_count = (
    SELECT COUNT(*) FROM ec_cross_border.amazonus_shopinfo_202504_sales
...
SET @valid_shop_count = (
    ...
    FROM ec_cross_border.amazonus_shopinfo_202504_sales
...
INSERT INTO etl_load_audit_2025_gj (
    ...
    '202504-2', 202504, 2, 'Amazon', 'amazonus_shopinfo_202504_sales',
    @source_row_count, @empty_shop_id_count, @valid_shop_count,
...
WHERE month_id = 202504 AND platform_id = 2;
...
WITH cleaned AS (
    ...
    FROM ec_cross_border.amazonus_shopinfo_202504_sales s
...
SELECT
    202504, 2, 'Amazon', a.shop_id, a.shop_name,
...
CALL sp_promote_dwd_batch_2025_gj(202504, 2);
