...
SET @source_row_count = (SELECT COUNT(*) FROM ec_cross_border.amazonus_shopinfo_202501_sales);
SET @empty_shop_id_count = (
    SELECT COUNT(*) FROM ec_cross_border.amazonus_shopinfo_202501_sales
...
SET @valid_shop_count = (
    ...
    FROM ec_cross_border.amazonus_shopinfo_202501_sales
...
INSERT INTO etl_load_audit_2025_gj (
    ...
    '202501-2', 202501, 2, 'Amazon', 'amazonus_shopinfo_202501_sales',
    @source_row_count, @empty_shop_id_count, @valid_shop_count,
...
WHERE month_id = 202501 AND platform_id = 2;
...
WITH cleaned AS (
    ...
    FROM ec_cross_border.amazonus_shopinfo_202501_sales s
...
SELECT
    202501, 2, 'Amazon', a.shop_id, a.shop_name,
...
CALL sp_promote_dwd_batch_2025_gj(202501, 2);
