...
CREATE TABLE IF NOT EXISTS dws_platform_month_summary_2025_gj
LIKE dws_platform_month_summary_2026_gj;

DELETE FROM dws_platform_month_summary_2025_gj
WHERE month_id BETWEEN 202501 AND 202506;

INSERT INTO dws_platform_month_summary_2025_gj (
